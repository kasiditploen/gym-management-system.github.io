            ...
            <div class="container-fluid">
	        	...
	        	<label for="image" class="col-sm-3 control-label"><h4><b>TRAINER IMAGE</b></h4></label>
                    ...
                    <option value="Female">Female</option>
                                        ...
                                        <div class="form-group">
                                            <div class="row">
                                                <label class="col-sm-3 control-label"><b>AVAILABLE DAY</b></label>
                                                <div class="col-sm-9">
                                                <input type="text"  name="availableday" id="boxx" class="form-control" required/>
                                                </div>
                                            </div>
                    ...
                    <div class="col-sm-9">
                                <select name="trainertype" id="Trainertype" required class="form-control">
