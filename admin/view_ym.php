...
?>
  ...
  <!-- Page wrapper  -->
        <div class="page-wrapper">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h3 class="text-primary"> Manage Yoga Mats/Exercise Mats</h3> </div>
                <div class="col-md-7 align-self-center">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="javascript:void(0)">Home</a></li>
                        <li class="breadcrumb-item active">View Yoga Mats/Exercise Mats</li>
                    </ol>
                </div>
            </div>
            <!-- End Bread crumb -->
        ...
        <tbody>
          <?php
          $query  = "select * from toe WHERE type='Yoga Mats/Exercise Mats'";
          //echo $query;
          ...
          <div class="card bg-primary p-10">
                            ...
                            $result = mysqli_query($con, 'SELECT SUM(amount) AS value_sum FROM toe WHERE type="Yoga Mats/Exercise Mats"'); 
          ...
          <div class="card bg-success p-10">
                            <div class="media widget-ten">
                                ...
                                <div class="media-body media-text-right">
                                    ...
                                    <h2 class="color-white"><?php
                            $query = "select COUNT(*) from toe WHERE type='Yoga Mats/Exercise Mats'";
                            ...
                            $i = 1;
                            ?></h2>
                                     <a><h2 class="color-white">Total Yoga Mats/Exercise Mats</h2></a>
                                </div>
                            </div>
                        </div>
                    </div>
