        ...
        <div class="page-wrapper">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h3 class="text-primary">Add New Commercial Flooring</h3> </div>
                <div class="col-md-7 align-self-center">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="javascript:void(0)">Home</a></li>
                        <li class="breadcrumb-item active">Add New Commercial Flooring</li>
                    </ol>
                </div>
            </div>
            <!-- End Bread crumb -->
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="input-states">
                                    <form class="form-horizontal" method="POST"  name="userform" enctype="multipart/form-data" action="submit_new_cf.php" id="submitProductForm" name="form1">
            ...
            ?>
                                                  <input type="text" name="cfid" id="cfID" readonly value="<?php echo time(); ?>" class="form-control">
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            <div class="row">
                                                ...
                                                <div class="col-sm-9">
                                                 <input name="cfname" id="cfName" type="text" placeholder="Enter Commercial Flooring name"class="form-control">
                                                </div>
                                            </div>
                                        </div>
	        	...
	        	<label for="image" class="col-sm-3 control-label"><h4><b>MODEL IMAGE</b></h4></label>
					        ...
					        <input type="file" class="form-control" id="image" placeholder="Product Name" name="image" class="file-loading" style="width:auto;" required/>
                                        ...
                                        <div class="form-group">
                                            <div class="row">
                                                ...
                                                <div class="col-sm-9">
                                                 <input type="text" name="desc" id="Desc" placeholder="Enter Commercial Flooring model" class="form-control" required/>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            <div class="row">
                                                ...
                                                <div class="col-sm-9">
                                                 <input type="text" name="brand" id="Brand" placeholder="Enter Commercial Flooring brand" class="form-control" required/>
                                                </div>
                                            </div>
                                        </div>
                    ...
                    <?php
                        $query="select * from categories where active='yes' AND toe='cf'";
                    ...
                    ?>
                                      ...
                                      <div class="form-group">
                                            <div class="row">
                                                ...
                                                <div class="col-sm-9">
                                                <input type="text" name="amount" id="Amnt" placeholder="Enter Commercial Flooring price in ฿"  class="form-control"  required/>
                                                </div>
                                            </div>
                                        </div>
