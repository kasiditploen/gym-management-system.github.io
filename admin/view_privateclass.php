...
?>
  ...
  <!-- Page wrapper  -->
        ...
        <tbody>
        <?php
              $query  = "select * from privateclasses WHERE classtype='Strength Training'";
              //echo $query;
              $result = mysqli_query($con, $query);
              $sno    = 1;
        ...
        <tbody>
        <?php
              $query  = "select * from privateclasses WHERE classtype='Dance'";
              //echo $query;
              $result = mysqli_query($con, $query);
              $sno    = 1;
        ...
        <tbody>
        <?php
              $query  = "select * from privateclasses WHERE classtype='Mind and Body'";
              //echo $query;
              $result = mysqli_query($con, $query);
              $sno    = 1;
          ...
          ?>  
                 ...
                 <div class="card">
                            <div class="card-body">
                            <h2 class="color-black">Swimming</h2></a>
                            <a href="new_privateclass.php"><button class="btn btn-primary">Add Class</button></a>
        ...
        <tbody>
        <?php
              $query  = "select * from privateclasses WHERE classtype='Swimming'";
              //echo $query;
              $result = mysqli_query($con, $query);
              $sno    = 1;
