...
if($res){
	...
	echo "
       ...
       <label class='col-sm-6 control-label'>VALIDITY</label>
        <div class='col-sm-4' style='width:330px;'>
          <input type='text' name='u_validate' id='boxx' value='".$row['validity']." Month' maxlength='30' readonly class='form-control' style='width:550px;'>
          </div>
          </div>
          </div>
          <div class='form-group'>
      ...
      <label class='col-sm-6 control-label'>SESSION</label>
       <div class='col-sm-4' style='width:330px;'>
         <input type='text' name='u_session' id='boxx' value='".$row['session']." Session(s)' maxlength='30' readonly class='form-control' style='width:550px;'>
         </div>
         </div>
         </div>
	";
