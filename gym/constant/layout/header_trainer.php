...
<?php 
include('../constant/check_trainer.php');
            ...
            <nav class="navbar top-navbar navbar-expand-md navbar-dark">
                ...
                <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle text-muted  " href="#" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                              <?php 
                                $sql = "select * from trainers where trainerid = '".$_SESSION["trainerid"]."'";
                                $query=$con->query($sql);
                            ...
                            <div class="dropdown-menu dropdown-menu-left animated zoomIn"><h3>Trainer: <?php echo $fname ?></h3>
