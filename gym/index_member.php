...
//echo $pass;
 $sql = "SELECT * FROM users WHERE email='" .$unm . "' and password = '". $pass."'and status = '1'";
  ...
  <div class="popup__content">
    ...
    <p>
     ...
     <?php echo "<script>setTimeout(\"location.href = './members/dashboard.php';\",1500);</script>"; ?>
    </p>
  </div>
</div>
   <!--   <script>
  ...
  <div class="popup__content">
    ...
    <p>
      <a href="index_member.php"><button class="button button--error" data-for="js_error-popup">Close</button></a>
    </p>
  </div>
</div>
       <!--  <script> 
                    ...
                    <div class="col-lg-3">
                        <div class="login-content card">
                            ...
                            <div class="login-form">
                                ...
                                <a href="index.php"><button name="user" class="btn btn-dark btn-xs m-b-20 m-t-20">Log in as Admin</button>
                                <a href="index_trainer.php"><button name="user" class="btn btn-dark btn-xs m-b-5 m-t-5">Log in as Trainer</button>
                            </div>
                        </div>
                    </div>
                </div>
