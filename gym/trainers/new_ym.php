        ...
        <div class="page-wrapper">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h3 class="text-primary">Add New Mats Equipment</h3> </div>
                <div class="col-md-7 align-self-center">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="javascript:void(0)">Home</a></li>
                        <li class="breadcrumb-item active">Add New Mats Equipment</li>
                    </ol>
                </div>
            </div>
            <!-- End Bread crumb -->
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="input-states">
                                    <form class="form-horizontal" method="POST"  name="userform" enctype="multipart/form-data" action="submit_new_ym.php" id="submitProductForm" name="form1">
            ...
            ?>
                                                  <input type="text" name="ymid" id="ymID" readonly value="<?php echo time(); ?>" class="form-control">
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            <div class="row">
                                                ...
                                                <div class="col-sm-9">
                                                 <input name="ymname" id="ymName" type="text" placeholder="Enter Mats Equipment name"class="form-control">
                                                </div>
                                            </div>
                                        </div>
	        	...
	        	<label for="image" class="col-sm-3 control-label"><h4><b>MODEL IMAGE</b></h4></label>
					        ...
					        <input type="file" class="form-control" id="image" placeholder="Product Name" name="image" class="file-loading" style="width:auto;" required/>
                                        ...
                                        <div class="form-group">
                                            <div class="row">
                                                ...
                                                <div class="col-sm-9">
                                                 <input type="text" name="desc" id="Desc" placeholder="Enter mat model" class="form-control" required/>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            <div class="row">
                                                ...
                                                <div class="col-sm-9">
                                                 <input type="text" name="brand" id="Brand" placeholder="Enter Mat brand" class="form-control" required/>
                                                </div>
                                            </div>
                                        </div>
                    ...
                    <?php
                        $query="select * from categories where active='yes' AND toe='ym'";
