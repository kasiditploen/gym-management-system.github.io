            ...
            <div class="card">
                    ...
                    <?php if(isset($_GET['classname'])){ echo $_GET['classname']; } ?>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="number" name="classcap" value="<?php if(isset($_GET['classcap']))?>" class="form-control">
                                    </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label></label> <br>
...
<?php 
                                ...
                                if( isset( $_GET['classcap'] ) && !empty( $_GET['classcap'] ) ){
                                  $clauses[] = "`classcap` = '{$_GET['classcap']}'";   
                              }
