...
?>
  ...
  <!-- Page wrapper  -->
        <div class="page-wrapper">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h3 class="text-primary"> Manage Rig System</h3> </div>
                <div class="col-md-7 align-self-center">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="javascript:void(0)">Home</a></li>
                        <li class="breadcrumb-item active">View Rig System</li>
                    </ol>
                </div>
            </div>
            <!-- End Bread crumb -->
            ...
            <div class="container-fluid">
                ...
                <!-- /# row -->
                 <div class="card">
                            ...
                            <a href="new_toe.php"><button class="btn btn-primary" id="addProductModalBtn">Add Rig System</button></a></div>
        ...
        <tbody>
          <?php
          $query  = "select * from toe WHERE type='Rig System'";
          //echo $query;
