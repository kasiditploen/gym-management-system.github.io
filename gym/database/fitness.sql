...
ALTER TABLE `trainertt`
  ...
  ADD KEY `trainer_IDtt` (`trainerid`) USING BTREE,
...
ALTER TABLE `trainertt`
  ...
  ADD CONSTRAINT `trainerIDtt` FOREIGN KEY (`trainerid`) REFERENCES `trainers` (`trainerid`) ON DELETE CASCADE ON UPDATE NO ACTION,
