            ...
            <div class="container-fluid">
                ...
                <!-- /# row -->
                 <div class="card">
                            ...
                            <a href="new_feedback.php?id=<?php echo $_SESSION["userid"];?>"><button class="btn btn-light">Add Feedback</button></a>
        ...
        <?php
          ...
          ?>  
                        ...
                        <div class="card">
                            ...
                            <a href="new_rating.php?id=<?php echo $_SESSION["userid"];?>"><button class="btn btn-light">Add Trainer Rating</button></a>
                                ...
                                <div class="table-responsive m-t-40">
                                    ...
                                    <table id="dt-all-checkbox" class="table table-bordered table-striped">
                                        ...
                                        <thead>
                                        <?php
          $query  = "select * from rating where userid='".$_SESSION["userid"]."'";
          //echo $query;
          $result = mysqli_query($con, $query);
          $sno    = 1;
