...
?>
  ...
  <!-- Page wrapper  -->
        <div class="page-wrapper">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h3 class="text-primary"> Manage MMA & Boxing</h3> </div>
                <div class="col-md-7 align-self-center">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="javascript:void(0)">Home</a></li>
                        <li class="breadcrumb-item active">View MMA & Boxing</li>
                    </ol>
                </div>
            </div>
            <!-- End Bread crumb -->
            ...
            <div class="container-fluid">
                ...
                <!-- /# row -->
                 <div class="card">
                            ...
                            <a href="new_toe.php"><button class="btn btn-primary" id="addProductModalBtn">Add MMA & Boxing</button></a></div>
        ...
        <tbody>
          <?php
          $query  = "select * from toe WHERE type='MMA & Boxing'";
          //echo $query;
          ...
          <div class="card bg-primary p-10">
                            ...
                            $result = mysqli_query($con, 'SELECT SUM(amount) AS value_sum FROM toe WHERE type="MMA & Boxing"'); 
