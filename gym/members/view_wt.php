...
?>
  ...
  <!-- Page wrapper  -->
        <div class="page-wrapper">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h3 class="text-primary"> Manage Weight Training</h3> </div>
                <div class="col-md-7 align-self-center">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="javascript:void(0)">Home</a></li>
                        <li class="breadcrumb-item active">View Weight Training</li>
                    </ol>
                </div>
            </div>
            <!-- End Bread crumb -->
            ...
            <div class="container-fluid">
                ...
                <!-- /# row -->
                 <div class="card">
                            ...
                            <a href="new_toe.php"><button class="btn btn-primary" id="addProductModalBtn">Add Weight Training</button></a></div>
        ...
        <tbody>
          <?php
          $query  = "select * from toe WHERE type='Weight Training'";
          //echo $query;
          ...
          if (mysqli_affected_rows($con) != 0) {
              while ($row = mysqli_fetch_array($result, MYSQLI_ASSOC)) {
                  ...
                  $query4="select * from categories WHERE categoryid = '$categoryid'";
                            ...
                            $query5="select * from vendors WHERE vendorid = '$vendorid'" ;
                  ...
                  <td style="width:10px; text-align: center;">
                    ...
                    <td><?php echo$row ['toeid']; ?></td>
                     ...
                     <td><?php echo$row5['vendorName'] ?></td>
          ...
          <div class="card bg-primary p-10">
                            ...
                            $result = mysqli_query($con, 'SELECT SUM(amount) AS value_sum FROM toe WHERE type="Weight Training"'); 
          ...
          <div class="card bg-success p-10">
                            <div class="media widget-ten">
                                ...
                                <div class="media-body media-text-right">
                                    ...
                                    <h2 class="color-white"><?php
                            $query = "select COUNT(*) from toe WHERE type='Weight Training'";
                            ...
                            $i = 1;
                            ?></h2>
                                     <a><h2 class="color-white">Total Weight Training</h2></a>
                                </div>
                            </div>
                        </div>
                    </div>
...
$sum = $row['value_sum'];
                            ?>
      <tr>
       <th colspan="8"><h3>Total Price</h3></th>
       <td></td>
       <td></td>     
