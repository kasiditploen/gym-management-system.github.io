...
?>
  ...
  <!-- Page wrapper  -->
        <div class="page-wrapper">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h3 class="text-primary"> Personal Trainer Appointment</h3> </div>
                <div class="col-md-7 align-self-center">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="javascript:void(0)">Home</a></li>
                        <li class="breadcrumb-item active">Personal Trainer Appointment</li>
                    </ol>
                </div>
            </div>
            <!-- End Bread crumb -->
        ...
        <tbody>
        <?php
              $query  = "select * from appointment where approved='yes'";
              //echo $query;
              $result = mysqli_query($con, $query);
              $sno    = 1;
              ...
              if (mysqli_affected_rows($con) != 0) {
                while ($row = mysqli_fetch_array($result, MYSQLI_ASSOC)) {
                 ...
                 <td>
                  ...
                  <a href="edit_trainer.php?id=<?php echo $row['classid'];?>"><button type="button" class="btn btn-xs btn-success" ><i class="fa fa-check"></i></button></a>
