...
include('../constant/connect.php');
                     $privateclassid=$_GET['id'];
                    
                    $query6  = "SELECT * FROM privateclasses c
                               INNER JOIN trainers t ON t.trainerid=c.trainerid
                               
                               WHERE privateclassid=".$_GET['id'];
                    //echo $query;
        ...
        <div class="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="input-states">
                                    <form class="form-horizontal" method="POST"  name="userform" enctype="multipart/form-data" action="edit_privateclass_submit.php" id="form1" name="form1">

                                    <div class="form-group">
                                            <div class="row">
                                                <label class="col-sm-3 control-label">Private Class ID</label>
                                                <div class="col-sm-9">
                                                
                                                  <input type="text" name="classid" id="classID" readonly value='<?php echo $privateclassid?>' class="form-control">
                                                </div>
                                            </div>
                                        </div>
                    ...
                    <?php
                        $query="select trainerid, username FROM trainers where trainertype LIKE'%Personal Trainer%'";
