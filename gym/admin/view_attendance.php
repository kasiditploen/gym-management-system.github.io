                ...
                <div class="card mt-4">
                    <div class="card-body">
                        <table class="table table-borderd">
                            ...
                            <?php 
                                 $query1  = "select * from users ORDER BY joining_date";
...
<?php 
                                 $query2  = "select * from users where users.userid='$uid'";
                                ...
                                if(isset($_GET['from_date']) && isset($_GET['to_date']))
                                {
                                    ...
                                    $sno    = 1;
                                    $query = "SELECT users.image,users.fname,users.lname,users.username,users.userid,checkin.checkinid,checkin.created_date,checkin.created_time FROM users  INNER JOIN checkin WHERE checkin.userid='$uid'  and created_date BETWEEN '$from_date' AND '$to_date' ";
