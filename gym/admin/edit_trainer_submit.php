...
include('../constant/connect.php');
   ...
   $remarks=$_POST['remarks'];
    ...
    $query1="update trainers set username='".$uname."',gender='".$gender."',mobile='".$mobile."',email='".$email."',dob='".$dob."',joining_date='".$jdate."' where trainerid='".$uid."'";
    //echo $query1;exit;

   if(mysqli_query($con,$query1)){
     $query2="update address2 set streetName='".$stname."',state='".$state."',city='".$city."',zipcode='".$zipcode."' where id='".$uid."'";
