...
<?php 
            ...
            <div class="card">
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="form-group">
                                            <div class="row">
                                                <label class="col-sm-3 control-label">Appointment Class Name</label>
                                                <div class="col-sm-9">
                                               <select name="classname" id="classname"   class="form-control">
                    <option value="">ALL</option>
                    <?php
                        $query="select appointmentid,className from appointment";
                        $result=mysqli_query($con,$query);
...
<?php 
                                 $query3  = "select * from appointment where userid = '$uid3'";
                                 $result3 = mysqli_query($con, $query3);
                                 while($row3=mysqli_fetch_array($result3)){
                                   $appointmentid=$row3['appointmentid'];
                                   //$usernamein=$rowme['username'];
                                 }
                                   ?>
      ...
      if( isset( $_GET['classname'] ) && !empty( $_GET['classname'] ) ){
        $clauses[] = "`appointmentid` = '{$_GET['classname']}'";   
    }
                                   ...
                                   // $from_date = $_GET['from_date'];
                                    ...
                                    LEFT OUTER JOIN  appointment p ON u.userid=p.userid where  a.type='apt' " . $where;
