...
$duplicate1=mysqli_query($con,"select * from booking where classid='$classid' and userid='$user' and trainerid='$trainer' and time_from='$time_from' and time_to='$time_to'");
...
$query0="INSERT INTO classholder (classholderid,classid,userid,trainerid,active,created_date,time_from,time_to) values('$classholderid','$classid','$user','$trainer','yes','$cdate','$time_from','$time_to')";
