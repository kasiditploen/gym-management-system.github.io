        ...
        <div class="page-wrapper">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h3 class="text-primary">Add Studio</h3> </div>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="input-states">
                                    <form class="form-horizontal" method="POST"  name="userform" enctype="multipart/form-data" action="submit_new_room.php" id="submitProductForm" name="form1">
            ...
            ?>
                                                  <input type="text" name="studioid" id="studioID" readonly value="<?php echo getRandomWord(); ?>" class="form-control">
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            <div class="row">
                                                ...
                                                <div class="col-sm-9">
                                                 <input name="studioname" id="studioName" type="text" placeholder="Enter machine name"class="form-control">
                                                </div>
                                            </div>
                                        </div>
