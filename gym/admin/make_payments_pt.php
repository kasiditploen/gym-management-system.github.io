                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="input-states">
                                    <form class="form-horizontal" method="POST"  name="userform" enctype="multipart/form-data" action="submit_payments_pt.php" id="form1" name="form1">
                                    <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            <div class="row">
                                                <label class="col-sm-3 control-label">RECENT EXPIRED PT SESSION</label>
                                                <div class="col-sm-9">
                                    ...
                                    <div class="form-group">
                                            <div class="row">
                                               ...
                                               <select name="pt" id="pt" required  onchange="myplandetail3(this.value)" class="form-control">
